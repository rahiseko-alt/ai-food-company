...
export const I18N = {
  ja: {
    ...
    'menu.callout_body': '30分の相談で、いまの人件費率とロス、いちばん時間を食っている作業を伺って、効く順番と概算費用、使える補助金までその場でお答えします。相談だけで終わっても構いません。',
    'menu.callout_cta': '無料で相談する ›',
    'menu.callout_note': 'オンライン30分／来店も可・岐阜県内は訪問可',
    ...
    'contact.lead': 'その場でお答えするのは3つです。いま何にいちばん時間とお金が漏れているか、どの順番で手をつけると早いか、概算費用と使える補助金。売り込みはしません。相談だけで終わって構いません。',
    'contact.dl_method_label': '相談方法',
    'contact.dl_method_value': 'オンライン30分／来店・訪問（岐阜・愛知）',
    ...
    'form.note': 'お急ぎの場合はお電話でも受け付けます（平日10:00–18:00）。',
  ...
  en: {
    ...
    'menu.callout_body': 'In a 30-minute conversation we’ll ask about your current labor-cost ratio, losses, and the task eating the most time, and answer on the spot — what order to tackle things in, a rough cost estimate, and any subsidies you can use. It’s fine if it ends with just a conversation.',
    'menu.callout_cta': 'Talk to us, free ›',
    'menu.callout_note': '30 min online / in-person visits also possible – on-site within Gifu Prefecture',
    ...
    'contact.lead': 'We’ll answer three things on the spot: where you’re losing the most time and money right now, what order to tackle things in for the fastest result, and a rough cost estimate plus any subsidies available. No sales pitch — it’s fine if it ends with just a conversation.',
    'contact.dl_method_label': 'Format',
    'contact.dl_method_value': '30 min online / in-person visit (Gifu, Aichi)',
    ...
    'form.note': 'If it’s urgent, we also take calls (weekdays 10:00–18:00).',
  ...
  zh: {
    ...
    'menu.callout_body': '在30分钟的沟通中，我们会询问您目前的人工成本率、损耗，以及最占用时间的工作，并当场回答应对的优先顺序、大致费用以及可用的补助金。即使只是聊聊也没关系。',
    'menu.callout_cta': '免费咨询 ›',
    'menu.callout_note': '线上30分钟／也可到店，岐阜县内可上门',
    ...
    'contact.lead': '我们会当场回答三件事：目前最耗费时间和金钱的地方在哪里、按什么顺序着手最快见效、以及大致费用和可用的补助金。不会强行推销，即使只是聊聊也没关系。',
    'contact.dl_method_label': '咨询方式',
    'contact.dl_method_value': '线上30分钟／到店或上门（岐阜、爱知）',
    ...
    'form.submit': '申请免费咨询 ›',
    'form.note': '如有急事也可致电咨询（工作日 10:00–18:00）。',
  ...
  ne: {
    ...
    'menu.callout_body': '३० मिनेटको सल्लाहमा, हालको श्रम लागत दर, नोक्सान, सबैभन्दा समय खाने काम सोधेर, प्रभावकारी क्रम, अनुमानित लागत, र प्रयोग गर्न सकिने अनुदानसम्म त्यहीँ जवाफ दिन्छौं। सल्लाह मात्रैमा सकिए पनि हुन्छ।',
    'menu.callout_cta': 'निःशुल्क सल्लाह लिनुहोस् ›',
    'menu.callout_note': 'अनलाइन ३० मिनेट／पसलमा आउन पनि सकिन्छ, गिफु प्रान्तभित्र भ्रमण सम्भव',
    ...
    'contact.lead': 'हामी त्यहीँ ३ कुरा जवाफ दिन्छौं: अहिले सबैभन्दा बढी समय र पैसा कहाँ चुहिँदैछ, कुन क्रममा सुरु गर्दा छिटो हुन्छ, अनुमानित लागत र प्रयोग गर्न सकिने अनुदान। बिक्री गर्न जोड दिँदैनौं। सल्लाह मात्रैमा सकिए पनि हुन्छ।',
    'contact.dl_method_label': 'सल्लाहको तरिका',
    'contact.dl_method_value': 'अनलाइन ३० मिनेट／पसलमा वा भ्रमण (गिफु, आइची)',
    ...
    'form.note': 'हतार भए फोनबाट पनि सम्पर्क गर्न सकिन्छ (कार्यदिन 10:00–18:00)।',
  ...
  vi: {
    ...
    'menu.callout_body': 'Trong buổi trao đổi 30 phút, chúng tôi sẽ hỏi về tỷ lệ chi phí nhân sự hiện tại, thất thoát, và công việc chiếm nhiều thời gian nhất, rồi trả lời ngay tại chỗ về thứ tự ưu tiên hiệu quả, chi phí ước tính, và các khoản trợ cấp có thể sử dụng. Chỉ trao đổi thôi cũng không sao.',
    'menu.callout_cta': 'Tư vấn miễn phí ›',
    'menu.callout_note': '30 phút trực tuyến／có thể đến trực tiếp, hỗ trợ đến tận nơi trong tỉnh Gifu',
    ...
    'contact.lead': 'Chúng tôi sẽ trả lời ngay 3 điều: hiện tại đang thất thoát nhiều thời gian và tiền bạc nhất ở đâu, nên bắt đầu theo thứ tự nào để nhanh có hiệu quả, chi phí ước tính và các khoản trợ cấp có thể dùng. Chúng tôi không chèo kéo bán hàng — chỉ trao đổi thôi cũng không sao.',
    'contact.dl_method_label': 'Hình thức',
    'contact.dl_method_value': '30 phút trực tuyến／đến cửa hàng hoặc đến tận nơi (Gifu, Aichi)',
    ...
    'form.note': 'Nếu gấp, quý khách cũng có thể gọi điện (ngày thường 10:00–18:00).',
  ...
  th: {
    ...
    'menu.callout_body': 'ในการพูดคุย 30 นาที เราจะสอบถามอัตราต้นทุนแรงงานปัจจุบัน ความสูญเสีย และงานที่กินเวลามากที่สุด แล้วตอบทันทีในเรื่องลำดับที่ควรเริ่มทำ ค่าใช้จ่ายโดยประมาณ และเงินอุดหนุนที่สามารถใช้ได้ แค่ปรึกษาเฉยๆ ก็ไม่เป็นไร',
    'menu.callout_cta': 'ปรึกษาฟรี ›',
    'menu.callout_note': 'ออนไลน์ 30 นาที／มาที่ร้านได้เช่นกัน สามารถลงพื้นที่ในจังหวัดกิฟุได้',
    ...
    'contact.lead': 'เราจะตอบ 3 เรื่องทันที คือ ตอนนี้เวลาและเงินรั่วไหลไปที่ใดมากที่สุด ควรเริ่มลำดับไหนก่อนถึงจะเห็นผลเร็ว และค่าใช้จ่ายโดยประมาณพร้อมเงินอุดหนุนที่ใช้ได้ เราไม่ยัดเยียดขายของ แค่ปรึกษาเฉยๆ ก็ไม่เป็นไร',
    'contact.dl_method_label': 'รูปแบบการปรึกษา',
    'contact.dl_method_value': 'ออนไลน์ 30 นาที／มาที่ร้านหรือให้ไปเยี่ยม (กิฟุ, ไอจิ)',
    ...
    'form.note': 'หากเร่งด่วน สามารถโทรติดต่อได้เช่นกัน (วันธรรมดา 10:00–18:00)',
